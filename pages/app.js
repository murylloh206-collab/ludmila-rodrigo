    ...
    if (error) {
      ...
      commentsData?.forEach(comment => {
        ...
        commentsByPost[comment.post_id].push({
          id: comment.id,
          author: comment.user_id === userId ? user?.nome_convidado : 'Convidado',
          text: comment.text,
